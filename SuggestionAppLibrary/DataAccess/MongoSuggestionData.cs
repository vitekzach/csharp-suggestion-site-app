...
public class MongoSuggestionData : ISuggestionData
{
    ...
    {
        var results = await _suggestions.FindAsync(s => id == s.Id);
    ...
    public async Task UpvoteSuggestion(string suggestionId, string userId)
    {
        ...
        try
        {
            ...
            var suggestionsInTransaction = db.GetCollection<SuggestionModel>(
                _db.SuggestionCollectionName
            );
            var suggestion = (
                await suggestionsInTransaction.FindAsync(s => s.Id == suggestionId)
            ).First();
            ...
            {
                var suggestionToRemove = user.VotedOnSuggestions
